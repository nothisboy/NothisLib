...
public class HttpManager {
    ...
    public String post(String urlString, Bundle bundle, boolean needCookie) throws IOException {
...
// remove the last &
        ...
        return post(urlString, postBody.toString(), needCookie);
    }
     ...
     *                       The method HttpURLConnection in JDK7 do not support PATCH yet.
     * @return
     * @throws IOException
     */
    public String post(String urlString, String postBody, boolean isPatchRequest, boolean needCookie) throws IOException {
    ...
    /**
     * Performs a HTTP POST with given postBody
     *
     * @param url
     * @param postBody
     * @return
     * @throws IOException
     */
    public String post(String url, String postBody, boolean needCookie)
            throws IOException {
// this is POST, so isPathRequest=false
        return post(url, postBody, false, needCookie);
    }
    ...
    protected boolean isCookieStored() {
